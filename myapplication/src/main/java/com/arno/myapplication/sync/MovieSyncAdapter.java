...
import com.arno.myapplication.DetailActivity;
...
public class MovieSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        if (typeExtras != null) {
            ...
            movieType = BaseConfig.getMovieType(getContext());
            URL url = BaseConfig.getMovieListUrl(getContext());
            getMovieListFromNetwork(url);
        }
    }
    ...
    private void getMoviesDetails() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                String urlStr = BaseConfig.getMovieDetailsUrl(id);
                try {
            ...
            Intent intent = new Intent("com.arno.myapplication.LOAD_FINISHED");
